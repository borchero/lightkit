...
html_theme_options = {
    ...
    "github_url": "https://github.com/borchero/lightkit",
}
...
autodoc_type_aliases = {
    "TensorData": ":class:`~lightkit.data.TensorData`",
    "DataLoader": ":class:`~lightkit.data.DataLoader`",
}
...
def format_annotation(annotation: Any, *args: Any, **kwargs: Any):  # type: ignore
...
def get_all_type_hints(obj: Any, name: str):  # type: ignore
    rv = {}
